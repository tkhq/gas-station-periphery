...
contract BaseDeployReimbursableGasStationUSDCFactory is Script {
    ...
    uint256 private constant BASE_GAS_FEE = 21000; // Base gas fee
    uint256 private constant MAX_GAS_LIMIT = 10_000_000_000; // Max gas limit in ERC20 tokens (10k USDC with 6 decimals)
    ...
    function run() external {
        ...
        ReimbursableGasStationUSDCFactory factory = new ReimbursableGasStationUSDCFactory(
            PRICE_FEED, REIMBURSEMENT_ERC20, TK_GAS_DELEGATE, GAS_FEE_BASIS_POINTS, BASE_GAS_FEE, MAX_GAS_LIMIT
        );
